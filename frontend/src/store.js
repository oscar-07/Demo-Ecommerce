...
const initialState = {
    userSignin:{           //localmente mi nombre
      userInfo: localStorage.getItem('userInfo') ? JSON.parse(localStorage.getItem('userInfo')) : null
    },
    cart:{                                                          //JSON.parse(JSON.stringify(obj))
      cartItems: localStorage.getItem('cartItems') ? localStorage.getItem('cartItems') : [],
      //cartItems: localStorage.getItem('cartItems') ? JSON.parse(localStorage.getItem('cartItems')) : []
      //cartItems: localStorage.getItem('cartItems') ? JSON.parse(JSON.stringify(localStorage.getItem('cartItems'))) : [],  //******
